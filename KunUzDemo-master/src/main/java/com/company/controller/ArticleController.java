...
public class ArticleController {
    ...
    @GetMapping("/public/{id}/lang")
    public ResponseEntity<?> getById(@PathVariable("id") Integer articleId,
                                     @RequestParam(name = "Accepted-Language", defaultValue = "uz") LangEnum lang) {
        return ResponseEntity.ok(articleService.getByIdPublished(articleId, lang));
    }

    @GetMapping("/public/region/{regionId}")
    public ResponseEntity<?> publishedListByRegionId(@PathVariable("regionId") Integer rId,
    ...
    @GetMapping("/public/type/pagination/{typeId}")
    ...
    public ResponseEntity<?> update(@PathVariable("id") Integer id,
        ...
        Integer pId = JwtUtil.getIdFromHeader(request, ProfileRole.ADMIN, ProfileRole.MODERATOR);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") Integer id, HttpServletRequest request) {
        JwtUtil.getIdFromHeader(request, ProfileRole.ADMIN, ProfileRole.MODERATOR);
